Simple console based program to evaluate prices for items in video game Warframe using warframe.market api to get relevant data.
...
This tool does not guarantee prices accuracy regarding item prices - use it to get a general idea about item's prices
